      ...
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <View style={styles.body}>
          ...
          >
            ...
            />
            <View style={{ flex: 1 }}>
              <NameWithBadge name={meetup.hostName} uid={meetup.hostUid} trustCount={0} nameStyle={[styles.hostName, { color: colors.text }]} />
          ...
          <View style={styles.attendeeList}>
            {meetup.attendees.map((a) => (
              ...
              >
                ...
                />
                <NameWithBadge name={a.displayName} uid={a.uid} trustCount={0} nameStyle={[styles.attendeeName, { color: colors.text }]} />
